...
<template>
  <div class="app-container">
    <el-form ref="form" :model="form" label-width="120px">
      ...
      <el-form-item v-if="isShowRemindDate" label="海报上传">
        <el-upload
        ...
        >
          <img v-if="posterUrl" :src="posterUrl" style="width: 100%; height: 100%" class="avatar">
          <i v-else class="el-icon-plus avatar-uploader-icon" />
        </el-upload>
      </el-form-item>
      <el-form-item v-if="isShowRemindDate" label="请填写天数">
        <el-input-number v-model="form.remind_date" controls-position="right" :min="1" :max="99999" />
      </el-form-item>
      <el-form-item v-if="isShowSort" label="排序">
        <el-input-number v-model="form.sort" controls-position="right" :min="0" :max="1000" />
      </el-form-item>
...
import { insertData, getAudioInfo } from '@/api/audio';
