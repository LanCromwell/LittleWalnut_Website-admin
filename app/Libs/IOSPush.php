...
class IOSPush {
    ...
    {
        $this->appkey = env('UMENG_APPKEY', '5d99ab193fc195ab2d0004f7');
        $this->appMasterSecret = env('UMENG_APP_MASTER_SECRET', 'ehietx88z4gt8mpqlwidncvxnmix4xhl');
        $this->timestamp = time();
    }
     ...
     * @throws \Exception
     */
    public function sendCustomizedcastData(string $aliasName, array $body, string $description = '')
    {
     ...
     * @throws \Exception
     */
    function sendIOSBroadcast($data = [], $policy = [])
    {
        if (!$data) {
