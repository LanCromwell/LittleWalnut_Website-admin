...
Route::group(['middleware' => 'api'], function () {
    ...
    Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function (){
        ...
        Route::get('front_users', 'UserController@index');
        Route::any('front_users/update', 'UserController@update');
        Route::any('front_users/update_pwd', 'UserController@updatePwd');
        Route::get('front_users/{id}', 'UserController@getUserInfo');
        Route::get('language', 'LanguageController@index');
        Route::get('category', 'CategoryController@index');
        Route::post('category/store', 'CategoryController@store');
        Route::get('category/{id}', 'CategoryController@show');
        Route::get('audio', 'AudioController@index');
        Route::get('audio/{id}', 'AudioController@getAudioInfo');
        Route::post('audio/store', 'AudioController@store');
        Route::get('date-poster', 'DatePosterController@index');
        Route::get('date-poster/{id}', 'DatePosterController@getDatePosterInfo');
        Route::post('date-poster/store', 'DatePosterController@store');
        Route::get('channel', 'ChannelController@index');
        Route::get('channel/{id}', 'ChannelController@getChannelInfo');
        Route::post('channel/store', 'ChannelController@store');
        Route::get('push_message', 'PushController@index');
        Route::post('push_message/edit', 'PushController@edit');
        Route::get('share', 'ShareController@index');
        Route::post('share/edit', 'ShareController@edit');
